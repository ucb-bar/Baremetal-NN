...
void init(Model *model) {
  ...
  NN_initTensor(&model->x, 4, (size_t[]){1, 224, 224, 3}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv0_0
  NN_initTensor(&model->conv0_0_weight, 4, (size_t[]){3, 3, 3, 16}, DTYPE_F32, array_pointer);
  array_pointer += 432;
  NN_initTensor(&model->conv0_0, 4, (size_t[]){1, 112, 112, 16}, DTYPE_F32, NULL);
  ...
  array_pointer += 16;
  NN_initTensor(&model->conv0_1, 4, (size_t[]){1, 112, 112, 16}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv0_2
  NN_initTensor(&model->conv0_2, 4, (size_t[]){1, 112, 112, 16}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv1_0
  NN_initTensor(&model->conv1_0_weight, 4, (size_t[]){3, 3, 1, 16}, DTYPE_F32, array_pointer);
  array_pointer += 144;
  NN_initTensor(&model->conv1_0, 4, (size_t[]){1, 112, 112, 16}, DTYPE_F32, NULL);
  ...
  array_pointer += 16;
  NN_initTensor(&model->conv1_1, 4, (size_t[]){1, 112, 112, 16}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv1_2
  NN_initTensor(&model->conv1_2, 4, (size_t[]){1, 112, 112, 16}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv1_3
  NN_initTensor(&model->conv1_3_weight, 4, (size_t[]){1, 1, 16, 56}, DTYPE_F32, array_pointer);
  array_pointer += 896;
  NN_initTensor(&model->conv1_3, 4, (size_t[]){1, 112, 112, 56}, DTYPE_F32, NULL);
  ...
  array_pointer += 56;
  NN_initTensor(&model->conv1_4, 4, (size_t[]){1, 112, 112, 56}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv1_5
  NN_initTensor(&model->conv1_5, 4, (size_t[]){1, 112, 112, 56}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv2_0
  NN_initTensor(&model->conv2_0_weight, 4, (size_t[]){3, 3, 1, 56}, DTYPE_F32, array_pointer);
  array_pointer += 504;
  ...
  NN_initTensor(&model->conv2_3_weight, 4, (size_t[]){1, 1, 56, 88}, DTYPE_F32, array_pointer);
  array_pointer += 4928;
  NN_initTensor(&model->conv2_3, 4, (size_t[]){1, 56, 56, 88}, DTYPE_F32, NULL);
  ...
  array_pointer += 88;
  NN_initTensor(&model->conv2_4, 4, (size_t[]){1, 56, 56, 88}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv2_5
  NN_initTensor(&model->conv2_5, 4, (size_t[]){1, 56, 56, 88}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv3_0
  NN_initTensor(&model->conv3_0_weight, 4, (size_t[]){3, 3, 1, 88}, DTYPE_F32, array_pointer);
  array_pointer += 792;
  NN_initTensor(&model->conv3_0, 4, (size_t[]){1, 56, 56, 88}, DTYPE_F32, NULL);
  ...
  array_pointer += 88;
  NN_initTensor(&model->conv3_1, 4, (size_t[]){1, 56, 56, 88}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv3_2
  NN_initTensor(&model->conv3_2, 4, (size_t[]){1, 56, 56, 88}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv3_3
  NN_initTensor(&model->conv3_3_weight, 4, (size_t[]){1, 1, 88, 120}, DTYPE_F32, array_pointer);
  array_pointer += 10560;
  NN_initTensor(&model->conv3_3, 4, (size_t[]){1, 56, 56, 120}, DTYPE_F32, NULL);
  ...
  array_pointer += 120;
  NN_initTensor(&model->conv3_4, 4, (size_t[]){1, 56, 56, 120}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv3_5
  NN_initTensor(&model->conv3_5, 4, (size_t[]){1, 56, 56, 120}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv4_0
  NN_initTensor(&model->conv4_0_weight, 4, (size_t[]){3, 3, 1, 120}, DTYPE_F32, array_pointer);
  array_pointer += 1080;
  NN_initTensor(&model->conv4_0, 4, (size_t[]){1, 28, 28, 120}, DTYPE_F32, NULL);
  ...
  array_pointer += 120;
  NN_initTensor(&model->conv4_1, 4, (size_t[]){1, 28, 28, 120}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv4_2
  NN_initTensor(&model->conv4_2, 4, (size_t[]){1, 28, 28, 120}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv4_3
  NN_initTensor(&model->conv4_3_weight, 4, (size_t[]){1, 1, 120, 144}, DTYPE_F32, array_pointer);
  array_pointer += 17280;
  NN_initTensor(&model->conv4_3, 4, (size_t[]){1, 28, 28, 144}, DTYPE_F32, NULL);
  ...
  array_pointer += 144;
  NN_initTensor(&model->conv4_4, 4, (size_t[]){1, 28, 28, 144}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv4_5
  NN_initTensor(&model->conv4_5, 4, (size_t[]){1, 28, 28, 144}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv5_0
  NN_initTensor(&model->conv5_0_weight, 4, (size_t[]){3, 3, 1, 144}, DTYPE_F32, array_pointer);
  array_pointer += 1296;
  NN_initTensor(&model->conv5_0, 4, (size_t[]){1, 28, 28, 144}, DTYPE_F32, NULL);
  ...
  array_pointer += 144;
  NN_initTensor(&model->conv5_1, 4, (size_t[]){1, 28, 28, 144}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv5_2
  NN_initTensor(&model->conv5_2, 4, (size_t[]){1, 28, 28, 144}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv5_3
  NN_initTensor(&model->conv5_3_weight, 4, (size_t[]){1, 1, 144, 256}, DTYPE_F32, array_pointer);
  array_pointer += 36864;
  NN_initTensor(&model->conv5_3, 4, (size_t[]){1, 28, 28, 256}, DTYPE_F32, NULL);
  ...
  array_pointer += 256;
  NN_initTensor(&model->conv5_4, 4, (size_t[]){1, 28, 28, 256}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv5_5
  NN_initTensor(&model->conv5_5, 4, (size_t[]){1, 28, 28, 256}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv6_0
  NN_initTensor(&model->conv6_0_weight, 4, (size_t[]){3, 3, 1, 256}, DTYPE_F32, array_pointer);
  array_pointer += 2304;
  NN_initTensor(&model->conv6_0, 4, (size_t[]){1, 14, 14, 256}, DTYPE_F32, NULL);
  ...
  array_pointer += 256;
  NN_initTensor(&model->conv6_1, 4, (size_t[]){1, 14, 14, 256}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv6_2
  NN_initTensor(&model->conv6_2, 4, (size_t[]){1, 14, 14, 256}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv6_3
  NN_initTensor(&model->conv6_3_weight, 4, (size_t[]){1, 1, 256, 408}, DTYPE_F32, array_pointer);
  array_pointer += 104448;
  NN_initTensor(&model->conv6_3, 4, (size_t[]){1, 14, 14, 408}, DTYPE_F32, NULL);
  ...
  array_pointer += 408;
  NN_initTensor(&model->conv6_4, 4, (size_t[]){1, 14, 14, 408}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv6_5
  NN_initTensor(&model->conv6_5, 4, (size_t[]){1, 14, 14, 408}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv7_0
  NN_initTensor(&model->conv7_0_weight, 4, (size_t[]){3, 3, 1, 408}, DTYPE_F32, array_pointer);
  array_pointer += 3672;
  NN_initTensor(&model->conv7_0, 4, (size_t[]){1, 14, 14, 408}, DTYPE_F32, NULL);
  ...
  array_pointer += 408;
  NN_initTensor(&model->conv7_1, 4, (size_t[]){1, 14, 14, 408}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv7_2
  NN_initTensor(&model->conv7_2, 4, (size_t[]){1, 14, 14, 408}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv7_3
  NN_initTensor(&model->conv7_3_weight, 4, (size_t[]){1, 1, 408, 376}, DTYPE_F32, array_pointer);
  array_pointer += 153408;
  NN_initTensor(&model->conv7_3, 4, (size_t[]){1, 14, 14, 376}, DTYPE_F32, NULL);
  ...
  array_pointer += 376;
  NN_initTensor(&model->conv7_4, 4, (size_t[]){1, 14, 14, 376}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv7_5
  NN_initTensor(&model->conv7_5, 4, (size_t[]){1, 14, 14, 376}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv8_0
  NN_initTensor(&model->conv8_0_weight, 4, (size_t[]){3, 3, 1, 376}, DTYPE_F32, array_pointer);
  array_pointer += 3384;
  NN_initTensor(&model->conv8_0, 4, (size_t[]){1, 14, 14, 376}, DTYPE_F32, NULL);
  ...
  array_pointer += 376;
  NN_initTensor(&model->conv8_1, 4, (size_t[]){1, 14, 14, 376}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv8_2
  NN_initTensor(&model->conv8_2, 4, (size_t[]){1, 14, 14, 376}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv8_3
  NN_initTensor(&model->conv8_3_weight, 4, (size_t[]){1, 1, 376, 272}, DTYPE_F32, array_pointer);
  array_pointer += 102272;
  NN_initTensor(&model->conv8_3, 4, (size_t[]){1, 14, 14, 272}, DTYPE_F32, NULL);
  ...
  array_pointer += 272;
  NN_initTensor(&model->conv8_4, 4, (size_t[]){1, 14, 14, 272}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv8_5
  NN_initTensor(&model->conv8_5, 4, (size_t[]){1, 14, 14, 272}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv9_0
  NN_initTensor(&model->conv9_0_weight, 4, (size_t[]){3, 3, 1, 272}, DTYPE_F32, array_pointer);
  array_pointer += 2448;
  NN_initTensor(&model->conv9_0, 4, (size_t[]){1, 14, 14, 272}, DTYPE_F32, NULL);
  ...
  array_pointer += 272;
  NN_initTensor(&model->conv9_1, 4, (size_t[]){1, 14, 14, 272}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv9_2
  NN_initTensor(&model->conv9_2, 4, (size_t[]){1, 14, 14, 272}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv9_3
  NN_initTensor(&model->conv9_3_weight, 4, (size_t[]){1, 1, 272, 288}, DTYPE_F32, array_pointer);
  array_pointer += 78336;
  NN_initTensor(&model->conv9_3, 4, (size_t[]){1, 14, 14, 288}, DTYPE_F32, NULL);
  ...
  array_pointer += 288;
  NN_initTensor(&model->conv9_4, 4, (size_t[]){1, 14, 14, 288}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv9_5
  NN_initTensor(&model->conv9_5, 4, (size_t[]){1, 14, 14, 288}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv10_0
  NN_initTensor(&model->conv10_0_weight, 4, (size_t[]){3, 3, 1, 288}, DTYPE_F32, array_pointer);
  array_pointer += 2592;
  NN_initTensor(&model->conv10_0, 4, (size_t[]){1, 14, 14, 288}, DTYPE_F32, NULL);
  ...
  array_pointer += 288;
  NN_initTensor(&model->conv10_1, 4, (size_t[]){1, 14, 14, 288}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv10_2
  NN_initTensor(&model->conv10_2, 4, (size_t[]){1, 14, 14, 288}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv10_3
  NN_initTensor(&model->conv10_3_weight, 4, (size_t[]){1, 1, 288, 296}, DTYPE_F32, array_pointer);
  array_pointer += 85248;
  NN_initTensor(&model->conv10_3, 4, (size_t[]){1, 14, 14, 296}, DTYPE_F32, NULL);
  ...
  array_pointer += 296;
  NN_initTensor(&model->conv10_4, 4, (size_t[]){1, 14, 14, 296}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv10_5
  NN_initTensor(&model->conv10_5, 4, (size_t[]){1, 14, 14, 296}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv11_0
  NN_initTensor(&model->conv11_0_weight, 4, (size_t[]){3, 3, 1, 296}, DTYPE_F32, array_pointer);
  array_pointer += 2664;
  NN_initTensor(&model->conv11_0, 4, (size_t[]){1, 14, 14, 296}, DTYPE_F32, NULL);
  ...
  array_pointer += 296;
  NN_initTensor(&model->conv11_1, 4, (size_t[]){1, 14, 14, 296}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv11_2
  NN_initTensor(&model->conv11_2, 4, (size_t[]){1, 14, 14, 296}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv11_3
  NN_initTensor(&model->conv11_3_weight, 4, (size_t[]){1, 1, 296, 328}, DTYPE_F32, array_pointer);
  array_pointer += 97088;
  NN_initTensor(&model->conv11_3, 4, (size_t[]){1, 14, 14, 328}, DTYPE_F32, NULL);
  ...
  array_pointer += 328;
  NN_initTensor(&model->conv11_4, 4, (size_t[]){1, 14, 14, 328}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv11_5
  NN_initTensor(&model->conv11_5, 4, (size_t[]){1, 14, 14, 328}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv12_0
  NN_initTensor(&model->conv12_0_weight, 4, (size_t[]){3, 3, 1, 328}, DTYPE_F32, array_pointer);
  array_pointer += 2952;
  NN_initTensor(&model->conv12_0, 4, (size_t[]){1, 7, 7, 328}, DTYPE_F32, NULL);
  ...
  array_pointer += 328;
  NN_initTensor(&model->conv12_1, 4, (size_t[]){1, 7, 7, 328}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv12_2
  NN_initTensor(&model->conv12_2, 4, (size_t[]){1, 7, 7, 328}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv12_3
  NN_initTensor(&model->conv12_3_weight, 4, (size_t[]){1, 1, 328, 480}, DTYPE_F32, array_pointer);
  array_pointer += 157440;
  NN_initTensor(&model->conv12_3, 4, (size_t[]){1, 7, 7, 480}, DTYPE_F32, NULL);
  ...
  array_pointer += 480;
  NN_initTensor(&model->conv12_4, 4, (size_t[]){1, 7, 7, 480}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv12_5
  NN_initTensor(&model->conv12_5, 4, (size_t[]){1, 7, 7, 480}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv13_0
  NN_initTensor(&model->conv13_0_weight, 4, (size_t[]){3, 3, 1, 480}, DTYPE_F32, array_pointer);
  array_pointer += 4320;
  NN_initTensor(&model->conv13_0, 4, (size_t[]){1, 7, 7, 480}, DTYPE_F32, NULL);
  ...
  array_pointer += 480;
  NN_initTensor(&model->conv13_1, 4, (size_t[]){1, 7, 7, 480}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv13_2
  NN_initTensor(&model->conv13_2, 4, (size_t[]){1, 7, 7, 480}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: conv13_3
  NN_initTensor(&model->conv13_3_weight, 4, (size_t[]){1, 1, 480, 512}, DTYPE_F32, array_pointer);
  array_pointer += 245760;
  NN_initTensor(&model->conv13_3, 4, (size_t[]){1, 7, 7, 512}, DTYPE_F32, NULL);
  ...
  array_pointer += 512;
  NN_initTensor(&model->conv13_4, 4, (size_t[]){1, 7, 7, 512}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU6'>: conv13_5
  NN_initTensor(&model->conv13_5, 4, (size_t[]){1, 7, 7, 512}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: decode_conv1_0_0
  NN_initTensor(&model->decode_conv1_0_0_weight, 4, (size_t[]){5, 5, 1, 512}, DTYPE_F32, array_pointer);
  array_pointer += 12800;
  NN_initTensor(&model->decode_conv1_0_0, 4, (size_t[]){1, 7, 7, 512}, DTYPE_F32, NULL);
  ...
  array_pointer += 512;
  NN_initTensor(&model->decode_conv1_0_1, 4, (size_t[]){1, 7, 7, 512}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU'>: decode_conv1_0_2
  NN_initTensor(&model->decode_conv1_0_2, 4, (size_t[]){1, 7, 7, 512}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: decode_conv1_1_0
  NN_initTensor(&model->decode_conv1_1_0_weight, 4, (size_t[]){1, 1, 512, 200}, DTYPE_F32, array_pointer);
  array_pointer += 102400;
  NN_initTensor(&model->decode_conv1_1_0, 4, (size_t[]){1, 7, 7, 200}, DTYPE_F32, NULL);
  ...
  array_pointer += 200;
  NN_initTensor(&model->decode_conv1_1_1, 4, (size_t[]){1, 7, 7, 200}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU'>: decode_conv1_1_2
  NN_initTensor(&model->decode_conv1_1_2, 4, (size_t[]){1, 7, 7, 200}, DTYPE_F32, NULL);
  NN_initTensor(&model->interpolate, 4, (size_t[]){1, 14, 14, 200}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: decode_conv2_0_0
  NN_initTensor(&model->decode_conv2_0_0_weight, 4, (size_t[]){5, 5, 1, 200}, DTYPE_F32, array_pointer);
  array_pointer += 5000;
  NN_initTensor(&model->decode_conv2_0_0, 4, (size_t[]){1, 14, 14, 200}, DTYPE_F32, NULL);
  ...
  array_pointer += 200;
  NN_initTensor(&model->decode_conv2_0_1, 4, (size_t[]){1, 14, 14, 200}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU'>: decode_conv2_0_2
  NN_initTensor(&model->decode_conv2_0_2, 4, (size_t[]){1, 14, 14, 200}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: decode_conv2_1_0
  NN_initTensor(&model->decode_conv2_1_0_weight, 4, (size_t[]){1, 1, 200, 256}, DTYPE_F32, array_pointer);
  array_pointer += 51200;
  NN_initTensor(&model->decode_conv2_1_0, 4, (size_t[]){1, 14, 14, 256}, DTYPE_F32, NULL);
  ...
  array_pointer += 256;
  NN_initTensor(&model->decode_conv2_1_1, 4, (size_t[]){1, 14, 14, 256}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU'>: decode_conv2_1_2
  NN_initTensor(&model->decode_conv2_1_2, 4, (size_t[]){1, 14, 14, 256}, DTYPE_F32, NULL);
  NN_initTensor(&model->interpolate_1, 4, (size_t[]){1, 28, 28, 256}, DTYPE_F32, NULL);
  NN_initTensor(&model->add, 4, (size_t[]){1, 28, 28, 256}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: decode_conv3_0_0
  NN_initTensor(&model->decode_conv3_0_0_weight, 4, (size_t[]){5, 5, 1, 256}, DTYPE_F32, array_pointer);
  array_pointer += 6400;
  NN_initTensor(&model->decode_conv3_0_0, 4, (size_t[]){1, 28, 28, 256}, DTYPE_F32, NULL);
  ...
  array_pointer += 256;
  NN_initTensor(&model->decode_conv3_0_1, 4, (size_t[]){1, 28, 28, 256}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU'>: decode_conv3_0_2
  NN_initTensor(&model->decode_conv3_0_2, 4, (size_t[]){1, 28, 28, 256}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: decode_conv3_1_0
  NN_initTensor(&model->decode_conv3_1_0_weight, 4, (size_t[]){1, 1, 256, 120}, DTYPE_F32, array_pointer);
  array_pointer += 30720;
  NN_initTensor(&model->decode_conv3_1_0, 4, (size_t[]){1, 28, 28, 120}, DTYPE_F32, NULL);
  ...
  array_pointer += 120;
  NN_initTensor(&model->decode_conv3_1_1, 4, (size_t[]){1, 28, 28, 120}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU'>: decode_conv3_1_2
  NN_initTensor(&model->decode_conv3_1_2, 4, (size_t[]){1, 28, 28, 120}, DTYPE_F32, NULL);
  NN_initTensor(&model->interpolate_2, 4, (size_t[]){1, 56, 56, 120}, DTYPE_F32, NULL);
  NN_initTensor(&model->add_1, 4, (size_t[]){1, 56, 56, 120}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: decode_conv4_0_0
  NN_initTensor(&model->decode_conv4_0_0_weight, 4, (size_t[]){5, 5, 1, 120}, DTYPE_F32, array_pointer);
  array_pointer += 3000;
  NN_initTensor(&model->decode_conv4_0_0, 4, (size_t[]){1, 56, 56, 120}, DTYPE_F32, NULL);
  ...
  array_pointer += 120;
  NN_initTensor(&model->decode_conv4_0_1, 4, (size_t[]){1, 56, 56, 120}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU'>: decode_conv4_0_2
  NN_initTensor(&model->decode_conv4_0_2, 4, (size_t[]){1, 56, 56, 120}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: decode_conv4_1_0
  NN_initTensor(&model->decode_conv4_1_0_weight, 4, (size_t[]){1, 1, 120, 56}, DTYPE_F32, array_pointer);
  array_pointer += 6720;
  ...
  NN_initTensor(&model->interpolate_3, 4, (size_t[]){1, 112, 112, 56}, DTYPE_F32, NULL);
  NN_initTensor(&model->add_2, 4, (size_t[]){1, 112, 112, 56}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: decode_conv5_0_0
  NN_initTensor(&model->decode_conv5_0_0_weight, 4, (size_t[]){5, 5, 1, 56}, DTYPE_F32, array_pointer);
  array_pointer += 1400;
  NN_initTensor(&model->decode_conv5_0_0, 4, (size_t[]){1, 112, 112, 56}, DTYPE_F32, NULL);
  ...
  array_pointer += 56;
  NN_initTensor(&model->decode_conv5_0_1, 4, (size_t[]){1, 112, 112, 56}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU'>: decode_conv5_0_2
  NN_initTensor(&model->decode_conv5_0_2, 4, (size_t[]){1, 112, 112, 56}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: decode_conv5_1_0
  NN_initTensor(&model->decode_conv5_1_0_weight, 4, (size_t[]){1, 1, 56, 16}, DTYPE_F32, array_pointer);
  array_pointer += 896;
  NN_initTensor(&model->decode_conv5_1_0, 4, (size_t[]){1, 112, 112, 16}, DTYPE_F32, NULL);
  ...
  array_pointer += 16;
  NN_initTensor(&model->decode_conv5_1_1, 4, (size_t[]){1, 112, 112, 16}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU'>: decode_conv5_1_2
  NN_initTensor(&model->decode_conv5_1_2, 4, (size_t[]){1, 112, 112, 16}, DTYPE_F32, NULL);
  NN_initTensor(&model->interpolate_4, 4, (size_t[]){1, 224, 224, 16}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.conv.Conv2d'>: decode_conv6_0
  NN_initTensor(&model->decode_conv6_0_weight, 4, (size_t[]){1, 1, 16, 1}, DTYPE_F32, array_pointer);
  array_pointer += 16;
  NN_initTensor(&model->decode_conv6_0, 4, (size_t[]){1, 224, 224, 1}, DTYPE_F32, NULL);
  ...
  array_pointer += 1;
  NN_initTensor(&model->decode_conv6_1, 4, (size_t[]){1, 224, 224, 1}, DTYPE_F32, NULL);

  // <class 'torch.nn.modules.activation.ReLU'>: decode_conv6_2
  NN_initTensor(&model->decode_conv6_2, 4, (size_t[]){1, 224, 224, 1}, DTYPE_F32, NULL);
