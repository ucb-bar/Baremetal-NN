...
void NN_mul_i8(size_t n, int8_t *y, size_t incy, const int8_t *x1, size_t incx1, const int8_t *x2, size_t incx2) {
  while (n > 0) {
    ...
    vint8m1_t vec_y = __riscv_vmul_vv_i8m1(vec_x1, vec_x2, vl);
...
void NN_mul_i16(size_t n, int16_t *y, size_t incy, const int16_t *x1, size_t incx1, const int16_t *x2, size_t incx2) {
  while (n > 0) {
    ...
    vint16m1_t vec_y = __riscv_vmul_vv_i16m1(vec_x1, vec_x2, vl);
...
void NN_mul_i32(size_t n, int32_t *y, size_t incy, const int32_t *x1, size_t incx1, const int32_t *x2, size_t incx2) {
  while (n > 0) {
    ...
    vint32m1_t vec_y = __riscv_vmul_vv_i32m1(vec_x1, vec_x2, vl);
...
#ifdef RISCV_ZVFH
  void NN_mul_f16(size_t n, float16_t *y, size_t incy, const float16_t *x1, size_t incx1, const float16_t *x2, size_t incx2) {
    while (n > 0) {
      size_t vl = __riscv_vsetvl_e16m1(n);
...
void NN_mul_f32(size_t n, float *y, size_t incy, const float *x1, size_t incx1, const float *x2, size_t incx2) {
  while (n > 0) {
    size_t vl = __riscv_vsetvl_e32m1(n);
