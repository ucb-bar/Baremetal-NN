        ...
        for (size_t oh = 0; oh < out_height; oh += 1) {
          for (size_t ow = 0; ow < out_width; ow += 1) {
                ...
                for (size_t kw = 0; kw < kernel_width; kw += 1) {
                  ...
                  if (ih < in_height && iw < in_width) {
                    size_t in_idx = n * in_channels * in_height * in_width
                                  + (g * (in_channels / groups) + ic) * in_height * in_width
                                  + ih * in_width
                                  + iw;
            ...
            size_t out_idx = n * out_channels * out_height * out_width
                               + (g * (out_channels / groups) + oc) * out_height * out_width
                               + oh * out_width
                               + ow;
              ...
              for (size_t kh = 0; kh < kernel_height; kh += 1) {
                for (size_t kw = 0; kw < kernel_width; kw += 1) {
                  ...
                  if (ih < in_height && iw < in_width) {
                    ...
                    size_t weight_idx = oc * (in_channels / groups) * kernel_height * kernel_width
                                        + ic * kernel_height * kernel_width
                                        + kh * kernel_width
                                        + kw;
