 ...
 * nn_nchw_to_nhwc_f32
 *
 * @brief Converts a 4D tensor from NCHW format to NHWC format.
 *
 ...
 * nn_nhwc_to_nchw_f32
 *
 * @brief Converts a 4D tensor from NHWC format to NCHW format.
 *
 * @param out The output tensor.
 * @param in The input tensor.
 */
 ...
 * nn_conv2d_f32
 *
 * @brief Performs a 2D convolution on a 4D tensor.
 *
 * @param out The output tensor.
 * @param in The input tensor.
