...
void NN_sub_u8(size_t n, uint8_t *z, size_t incz, const uint8_t *x, size_t incx, const uint8_t *y, size_t incy) {
  while (n > 0) {
...
void NN_sub_i8(size_t n, int8_t *z, size_t incz, const int8_t *x, size_t incx, const int8_t *y, size_t incy) {
  while (n > 0) {
    size_t vl = __riscv_vsetvl_e8m1(n);
...
void NN_sub_i16(size_t n, int16_t *z, size_t incz, const int16_t *x, size_t incx, const int16_t *y, size_t incy) {
  while (n > 0) {
...
void NN_sub_i32(size_t n, int32_t *z, size_t incz, const int32_t *x, size_t incx, const int32_t *y, size_t incy) {
  while (n > 0) {
...
#ifdef RISCV_ZVFH
  void NN_sub_f16(size_t n, float16_t *z, size_t incz, const float16_t *x, size_t incx, const float16_t *y, size_t incy) {
    while (n > 0) {
      size_t vl = __riscv_vsetvl_e16m1(n);
...
void NN_sub_f32(size_t n, float *z, size_t incz, const float *x, size_t incx, const float *y, size_t incy) {
  while (n > 0) {
    size_t vl = __riscv_vsetvl_e32m1(n);
