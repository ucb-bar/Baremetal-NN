...
void NN_minimum1_i8(size_t n, int8_t *y, size_t incy, const int8_t *x, size_t incx, int8_t s) {
  while (n > 0) {
...
void NN_minimum1_i16(size_t n, int16_t *y, size_t incy, const int16_t *x, size_t incx, int16_t s) {
  while (n > 0) {
...
void NN_minimum1_i32(size_t n, int32_t *y, size_t incy, const int32_t *x, size_t incx, int32_t s) {
  while (n > 0) {
...
#ifdef RISCV_ZVFH
  void NN_minimum1_f16(size_t n, float16_t *y, size_t incy, const float16_t *x, size_t incx, float16_t s) {
    while (n > 0) {
      size_t vl = __riscv_vsetvl_e16m1(n);
...
void NN_minimum1_f32(size_t n, float *y, size_t incy, const float *x, size_t incx, float s) {
  while (n > 0) {
    size_t vl = __riscv_vsetvl_e32m1(n);
