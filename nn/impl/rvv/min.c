...
void NN__min_i8(size_t n, int8_t *result, const int8_t *x, size_t incx) {
...
void NN__min_i16(size_t n, int16_t *result, const int16_t *x, size_t incx) {
...
void NN__min_i32(size_t n, int32_t *result, const int32_t *x, size_t incx) {
