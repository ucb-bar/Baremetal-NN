...
void NN__acc1_i8(size_t n, int8_t *result, size_t incx, int8_t scalar) {
  while (n > 0) {
...
void NN__acc1_i16(size_t n, int16_t *result, size_t incx, int16_t scalar) {
  while (n > 0) {
...
void NN__acc1_i32(size_t n, int32_t *result, size_t incx, int32_t scalar) {
  while (n > 0) {
