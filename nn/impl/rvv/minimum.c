...
void NN__minimum_i8(size_t n, int8_t *z, size_t incz, const int8_t *x, size_t incx, const int8_t *y, size_t incy) {
  while (n > 0) {
    ...
    vint8m1_t vec_z = __riscv_vmin_vv_i8m1(vec_x, vec_y, vl);
...
void NN__minimum_i16(size_t n, int16_t *z, size_t incz, const int16_t *x, size_t incx, const int16_t *y, size_t incy) {
  while (n > 0) {
    ...
    vint16m1_t vec_z = __riscv_vmin_vv_i16m1(vec_x, vec_y, vl);
...
void NN__minimum_i32(size_t n, int32_t *z, size_t incz, const int32_t *x, size_t incx, const int32_t *y, size_t incy) {
  while (n > 0) {
    ...
    vint32m1_t vec_z = __riscv_vmin_vv_i32m1(vec_x, vec_y, vl);
...
#ifdef ZVFH
  void NN__minimum_f16(size_t n, float16_t *z, size_t incz, const float16_t *x, size_t incx, const float16_t *y, size_t incy) {
    while (n > 0) {
      size_t vl = __riscv_vsetvl_e16m1(n);
      ...
      vfloat16m1_t vec_z = __riscv_vfmin_vv_f16m1(vec_x, vec_y, vl);
...
void NN__minimum_f32(size_t n, float *z, size_t incz, const float *x, size_t incx, const float *y, size_t incy) {
  while (n > 0) {
    size_t vl = __riscv_vsetvl_e32m1(n);
