...
void NN__abs_i8(size_t n, int8_t *y, size_t incy, const int8_t *x, size_t incx) {
  while (n > 0) {
...
void NN__abs_i16(size_t n, int16_t *y, size_t incy, const int16_t *x, size_t incx) {
  while (n > 0) {
...
void NN__abs_i32(size_t n, int32_t *y, size_t incy, const int32_t *x, size_t incx) {
  while (n > 0) {
...
void NN__abs_f16(size_t n, float16_t *y, size_t incy, const float16_t *x, size_t incx) {
  while (n > 0) {
    size_t vl = __riscv_vsetvl_e16m1(n);
...
void NN__abs_f32(size_t n, float *y, size_t incy, const float *x, size_t incx) {
  while (n > 0) {
    size_t vl = __riscv_vsetvl_e32m1(n);
